...
class DoomGame:
    ...
    def set_config(self, config: typing.Union[str, typing.Dict[str, typing.Any]]) -> bool:
        """
...
class GameVariable:
    ...
    PLAYER_KILLCOUNT: typing.ClassVar[
        GameVariable
    ]  # value = <GameVariable.PLAYER_KILLCOUNT: 132>
...
PLAYER_KILLCOUNT: GameVariable  # value = <GameVariable.PLAYER_KILLCOUNT: 132>
